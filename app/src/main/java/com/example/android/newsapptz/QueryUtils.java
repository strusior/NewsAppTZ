...
public final class QueryUtils {
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of newses
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Get a single piece of news at position i within the list of newses
                JSONObject currentNews = newsArray.getJSONObject(i);

                // For a given news, extract the JSONObject associated with the
                // key called "sectionName" which is a section of news
                String section;
                ...
                News news = new News(title, section, newsUrl);

                // Add the new news to the list of newses.
                newses.add(news);
            }
